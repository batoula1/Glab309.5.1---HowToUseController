...
public class RequestParamController {
    ...
    @ResponseBody
    public String handler(@RequestParam String firstName,
                          @RequestParam String lastName){
        return "URL parameters - <br>" + " firstName = " + firstName
    ...
    public String handler(@RequestParam("firstName") String firstName,
                          @RequestParam(value = "middleName", required =
                                  false) String middleName, @RequestParam(
    ...
    public String handler(
        ...
        return "URL parameters - <br>" + " date = " + date + " <br>" + " time" +
                " = " + time;
    }
